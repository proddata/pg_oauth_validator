...
pg_oauth_validator_error_code(PgOAuthValidatorError error)
{
	switch (error)
	{
		case PG_OAUTH_VALIDATOR_OK: return "validator_ok";
		case PG_OAUTH_VALIDATOR_INVALID_ARGUMENT: return "validator_invalid_argument";
		case PG_OAUTH_VALIDATOR_ENVELOPE: return "validator_envelope";
		case PG_OAUTH_VALIDATOR_ISSUER_KEY: return "validator_issuer_key";
		case PG_OAUTH_VALIDATOR_SIGNATURE: return "validator_signature";
		case PG_OAUTH_VALIDATOR_CLAIMS: return "validator_claims";
		case PG_OAUTH_VALIDATOR_IDENTITY: return "validator_identity";
	}
